...
public class QuantityMeasurementAppTest {
    ...
    void testEquality_CMToCM_SameValue() {
        var q1 = new QuantityMeasurementApp.Quantity(2.0, QuantityMeasurementApp.LengthUnit.CM);
        var q2 = new QuantityMeasurementApp.Quantity(2.0, QuantityMeasurementApp.LengthUnit.CM);
